use chumsky::Parser;
use parser::{markdown_parser, InlineMarkdownNode, LinkType, MarkdownNode};
...
fn main() {
    ...
    println!("Parsed: {:?}, errors: {}", result2.0.is_some(), result2.1.len());
    ...
    println!("\n=== List (unsupported) ===");
    println!("Parsed: {:?}, errors: {}", result5.0.is_some(), result5.1.len());
    ...
    println!("Parsed: {:?}, errors: {}", result6.0.is_some(), result6.1.len());
}
