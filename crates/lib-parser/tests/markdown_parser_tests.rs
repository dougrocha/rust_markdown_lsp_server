...
use common::compare;
// use lib_parser::{markdown::*, InlineMarkdownNode, MarkdownNode, parser, SectionRef};
...
//     let input = "[[target]]";
//     let expected = InlineMarkdownNode::WikiLink {
//         target: "target",
//         alias: None,
//         header: None,
//     };
...
//     let expected = InlineMarkdownNode::Link {
//         title: "Link Text",
...
//     let expected = InlineMarkdownNode::Image {
//         alt_text: "Alt Text",
//         uri: "image.png",
//     };
...
//     let expected = InlineMarkdownNode::PlainText(input);
...
//     let input = "[^abc]";
//     let expected = InlineMarkdownNode::Footnote("abc");
//     compare(footnote_parser(), input, expected);
// }
//
// #[test]
...
//     let input = "[^a1b2]";
//     let expected = InlineMarkdownNode::Footnote("a1b2");
//     compare(footnote_parser(), input, expected);
// }
//
// #[test]
...
//     let input = "[^123]";
//     let expected = InlineMarkdownNode::Footnote("123");
//     compare(footnote_parser(), input, expected);
// }
//
// #[test]
...
//     let input = "[^aBc12]";
//     let expected = InlineMarkdownNode::Footnote("aBc12");
//     compare(footnote_parser(), input, expected);
// }
//
// #[test]
